...
public class AiControlller {
    ...
    public ResponseEntity<ApiResponse<AiJobStartResponse>> startWorkflow(
        ...
        log.info("AiController startWorkflow 진입 | projectId={} requestedBy={}",
    ...
    public ResponseEntity<ApiResponse<AiWorkflowStatusResponse>> getWorkflowStatus(
        ...
        log.info("AiController getWorkflowStatus 진입 | jobId={}", jobId);
        return ResponseEntity.ok(ApiResponse.success(aiService.getWorkflowStatus(jobId)));
    }
}
